...
import ContentfulImageGsap from '@/components/ui/ContentfulImageGsap'
...
export async function getStaticProps() {
  const result = await fetch(`https://graphql.contentful.com/content/v1/spaces/${process.env.CONTENTFUL_SPACE_ID}/environments/master`, {
    ...
    body: JSON.stringify({
      query: `
        query {
          stickyStay:stayCollection(where: { category: "Great Room & Kitchen", featured:true, sticky:true }, limit: 1) {
            items {
              title
              slug
              content {
